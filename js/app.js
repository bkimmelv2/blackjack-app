...
const returnCards = () => {
    fetch('https://www.deckofcardsapi.com/api/deck/blqor7miyg67/return/')
...
const initDeal = () => {
    fetch('https://www.deckofcardsapi.com/api/deck/blqor7miyg67/draw/?count=4')
    .then((data) => {
        return data.json()
    },
    (err) => {
...
hitMeButton.addEventListener('click', () => {
    fetch('https://www.deckofcardsapi.com/api/deck/blqor7miyg67/draw/?count=1')
    .then((data) => {
        return data.json()
    },
    (err) => {
