...
const returnCards = () => {
    fetch('https://www.deckofcardsapi.com/api/deck/vb5a9ycnnupn/return/')
...
const initDeal = () => {
    fetch('https://www.deckofcardsapi.com/api/deck/vb5a9ycnnupn/draw/?count=4')
    .then((data) => {
        return data.json()
    },
    (err) => {
...
hitMeButton.addEventListener('click', () => {
    fetch('https://www.deckofcardsapi.com/api/deck/vb5a9ycnnupn/draw/?count=1')
    .then((data) => {
        return data.json()
    },
    (err) => {
