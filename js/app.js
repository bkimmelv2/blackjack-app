...
const returnCards = () => {
    fetch('https://www.deckofcardsapi.com/api/deck/9v2lcims0w0b/return/')
...
const initDeal = () => {
    fetch('https://www.deckofcardsapi.com/api/deck/9v2lcims0w0b/draw/?count=4')
    .then((data) => {
        return data.json()
    },
    (err) => {
...
hitMeButton.addEventListener('click', () => {
    fetch('https://www.deckofcardsapi.com/api/deck/9v2lcims0w0b/draw/?count=1')
    .then((data) => {
        return data.json()
    },
    (err) => {
